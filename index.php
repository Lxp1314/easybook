            ...
            wx.getLocalImgData({
                ...
                success: function(res) {
                    ...
                    $.ajax({
                        ...
                        async: true,
                        data: {
                            action: 'base64_upload',
                            media_id: document.getElementById('inputOne').value,
                            base64: localData
                        },
                        beforeSend: function () {
                        },
...
<?php } ?>
        ...
        $(document).ready(function(){
            if(isWeixin()){
                if(isAndroid()){
                    document.getElementById("inputOs").value='android';
                }else{
                    document.getElementById("inputOs").value='ios';
                }
            }else{
                document.getElementById("inputOs").value='not weixin';
            }
        });
    </script>
    ...
    <input type="text" id="inputOs" value="" />
    <img id="img0" />
    <img id="img1" />
    <img id="img2" />
    <img id="img3" />
    ...
    <button onclick="uploadOneBase64Image()">上传Base64</button>
